...
speed_profile = {
    ["primary"] = { speed = 45, access = true },
    ["primary_link"] = { speed = 45, access = true },
    ["secondary"] = { speed = 45, access = true },
    ["secondary_link"] = { speed = 45, access = true },
    ["tertiary"] = { speed = 45, access = true },
    ["tertiary_link"] = { speed = 45, access = true },
    ["unclassified"] = { speed = 45, access = true },
    ["residential"] = { speed = 45, access = true },
    ["service"] = { speed = 45, access = true },
    ["services"] = { speed = 45, access = true },
    ["road"] = { speed = 45, access = true },
    ["track"] = { speed = 45, access = true },
    ["cycleway"] = { speed = 45, access = true },
    ["footway"] = { speed = 45, access = false },
    ["pedestrian"] = { speed = 45, access = false },
    ["path"] = { speed = 45, access = true },
    ["living_street"] = { speed = 45, access = true },
    ["ferry"] = { speed = 45, access = true },
    ["movable"] = { speed = 45, access = true },
    ["shuttle_train"] = { speed = 45, access = true },
    ["default"] = { speed = 45, access = true }
}
