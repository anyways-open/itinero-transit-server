...
namespace Itinero.Transit.Api.Models
{
    ...
    public class StatusReport
    {
        ...
        /// </summary>
        public readonly int LoadedLocationsCount;

        /// <summary>
        /// The expected number of locations that will be loaded in the database when done
        /// </summary>
        public readonly int TargetLocationsCount;
        ...
        /// </summary>
        public readonly int LoadedConnections;
        ...
        /// </summary>
        public readonly DateTime FirstConnectionDeparture;
        ...
        /// </summary>
        public readonly DateTime LastConnectionDeparture;
        ...
        /// </summary>
        public readonly DateTime TargetLastConnectionDeparture;

        /// <summary>
        /// The estimate percentage of loaded connections
        /// </summary>
        public readonly float PercentageLoaded;

        /// <summary>
        /// Estimates how many seconds that are still needed to load the entire database
        /// </summary>
        public readonly int EstimatedTimeLeft;

        public StatusReport(DateTime onlineSince, long uptime, int loadedLocations, int targetLocationsCount,
